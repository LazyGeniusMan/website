...
**Andriyansyah Nurrachman** is an undergraduate Accounting student who has an interest in the field of Information Technology and specialized in Information System and Business Process Management domain.
...
- Designed business process, chart of account and and accounting treatment for e-commerce company.
- Prepared functional specification document and designed wireframe for Accounting Information System application.
- Ensured that the Accounting Information System application meet business requirements and in line with accounting standards by preparing test case and testing it.
...
- Designed executable business process model using Business Process Model and Notation (BPMN) and Decision Model and Notation (DMN).
- Designed wireframe for tax collection application.
- Identified accounting treatment for tax collection process.
- Ensured that the tax collection application meet business requirements and in line with tax law by preparing test case and testing it.
...
- Developed and implement Standard Operating Procedure for ERP usage.
- Ensured that the developed ERP is in line with business process and meet user requirements by validating it to
  the user.
